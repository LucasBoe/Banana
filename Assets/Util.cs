...
public static class Util
{
    ...
    public static void DebugDrawCross(Vector3 position, Color color, float size, float lifetime = -1f)
    {
        if (lifetime < 0)
        {
            Debug.DrawLine(position + new Vector3(size / 2, size / 2, size / 2), position + new Vector3(-size / 2, -size / 2, size / 2), color);
            Debug.DrawLine(position + new Vector3(-size / 2, size / 2, size / 2), position + new Vector3(size / 2, -size / 2, size / 2), color);
        }
        else
        {
            Debug.DrawLine(position + new Vector3(size / 2, size / 2, size / 2), position + new Vector3(-size / 2, -size / 2, size / 2), color, lifetime);
            Debug.DrawLine(position + new Vector3(-size / 2, size / 2, size / 2), position + new Vector3(size / 2, -size / 2, size / 2), color, lifetime);
        }
    }
    ...
    public static int GetRandom(this int[] ints)
    {
        return ints[UnityEngine.Random.Range(0, ints.Length)];
    }
